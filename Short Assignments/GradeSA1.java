...
//        // 1. Define a new subclass of Blob named WanderingPixel.
...
//        Blob pw = new WanderingPixel(x, y);
//        points += AutogradeCommon.displayMessage(pw.getX() == x && pw.getY() == y, 0.25,
//                "not defining WanderingPixel as a subclass of Blob nor calling the super constructor");
//
...
//        WanderingPixel pw2 = new WanderingPixel(x, y);
//        int minFound = 10, maxFound = 4;
//        for (int i = 0; i < 100; i++) {
//            pw2 = new WanderingPixel(x, y);
